...
import org.bigData.utils.SparkUtil;
import scala.Tuple2;
import org.bigData.utils.Tuple3;
import org.bigData.utils.Tuple7;
...
public class MovieRecommendation {
    public static void main(String[] args) throws Exception {
      ...
      JavaRDD<String> formattedCorr = corr.map(
         pair -> {
             // Get the movie pair and the tuple values
             String movie1 = pair._1._1;
             String movie2 = pair._1._2;
             Double val1 = pair._2._1;
             Double val2 = pair._2._2;
             Double val3 = pair._2._3;
     
             // Return a CSV formatted string
             return movie1 + "," + movie2 + "," + val1 + "," + val2 + "," + val3;
         }
     );
      
      
      formattedCorr.saveAsTextFile("/movies/output");
      System.exit(0);
    }
